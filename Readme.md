...
| Split  | Images | % of total | knife | long_gun | no_weapon | pistol |
|------- | ------:| ----------:| -----:| --------:| ---------:| ------:|
| Train  | 49,079 | 82.76%     | 10,511 (16.57%) | 19,273 (30.37%) | 10,161 (16.01%) | 23,507 (37.05%) |
| Valid  | 7,552  | 12.73%     | 1,813 (18.63%)  | 2,750 (28.26%)  | 1,324 (13.61%)  | 3,843 (39.50%)  |
| Test   | 2,674  | 4.51%      | 686 (19.47%)    | 941 (26.71%)    | 656 (18.62%)    | 1,240 (35.19%)  |
| **Total** | **59,305** | **100%** | **13,010 (16.96%)** | **22,964 (29.94%)** | **12,141 (15.83%)** | **28,590 (37.27%)** |

> Percentages in class columns are the share **within each split**; the **Total** row shows class share across the whole dataset.
